...
namespace FavoritaClickShop.Forms
{
    public partial class FormCliente : Form
    {
        ...
        {
            InitializeComponent();
           // ColorBotones.SetPanelColors(panel1, Color.White, Color.White, 0);
           // ColorBotones.SetPanelColors(panel2, Color.DimGray, Color.Gray, 0);
            ...
            dataGridCliente.RowTemplate.Height = 60;
